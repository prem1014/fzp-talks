        ...
        <>
            <div className="row marginTop20px">
                <div className="col-12">
                    ...
                    <p className="text-center">सर्वे कराने का मकसद सिर्फ और सिर्फ लोगो को विचार जानने का था लेकिन कुछ लोगों इसे गलत दिशा में ले जा रहे है इसलिए सर्वे को बंद किया जा रहा है। आप लोगो का बहुत बहुत धन्यवाद। </p>
