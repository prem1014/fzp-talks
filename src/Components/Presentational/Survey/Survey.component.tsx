        ...
        <>
            <div className="row marginTop20px">
                <div className="col-12">
                    ...
                    <p className="text-center">आप लोगो से OTP इसलिए सत्यापित किया जा रहा है ताकि बोगस वोटिंग न हो । आपका कोई भी डाटा जैसे की ईमेल या मोबाइल या OTP  कही भी सेभ नहीं किया जा रहा है।  आप हमारी तरफ से निहचिंत रहे की आपका कोई भी डाटा चुराया नहीं जायेगा। अगर फिर भी आपको लगे की कुछ गलत हो सकता है तो आप सर्वे में भाग नहीं ले । </p>
